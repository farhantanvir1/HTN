...
def load_drug_data(device):
    ...
    drug_path = '/content/drive/MyDrive/HTN-main 3/drug_feature.csv'
    target_path = '/content/drive/MyDrive/HTN-main 3/target_feature.csv'

    drug_df = pd.read_csv(drug_path)
    target_df = pd.read_csv(target_path)

    # Load the drug-target interaction dataset
    drug_target_interactions = pd.read_csv("/content/drive/MyDrive/HTN-main 3/drug_target_data_drugbank_final.csv")

    # Load the drug-disease interaction dataset
    drug_disease_interactions = pd.read_csv("/content/drive/MyDrive/HTN-main 3/drug_indication_data_drugbank_final.csv")
...
class EarlyStopping(object):
    ...
    def load_checkpoint(self, model):
        model.load_state_dict(torch.load(self.filename))#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 16:49:05 2021
